  ...
  theme: {
    extend: {
      ...
      spacing: {
        ...
        "memo-x-sm": "2.5rem",
        "memo-x-lg": "3.5rem",
        "memo-header-y": "1.75rem",
        "memo-header-y-sm": "2rem",
        "memo-section-y": "2rem",
        "memo-section-y-sm": "2.25rem",
        "memo-section-y-lg": "2.5rem",
        "memo-comparison-y": "2.25rem",
        "memo-comparison-y-sm": "2.5rem",
        "memo-comparison-y-lg": "2.75rem",
        "memo-row-x": "1rem",
        "memo-row-x-sm": "1.25rem",
        "memo-row-y": "1rem",
        "memo-header-cell-y": "0.875rem",
        "memo-footer-y": "2rem"
      },
      boxShadow: {
